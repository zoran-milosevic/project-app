...
{
    public partial class Initial_Auth_Database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "d7ae4ff7-e9d2-43e3-ab5f-077b6f38a946", "SuperAdmin", "SUPERADMIN" },
                    { 2, "4171699a-85ec-482f-9134-5e0bde9030a6", "Admin", "ADMIN" },
                    { 3, "7f0655eb-43e1-45cb-ab1f-23c7fd40a557", "User", "USER" }
                });

            migrationBuilder.InsertData(
                schema: "Security",
                table: "User",
                columns: new[] { "UserId", "AccessFailedCount", "ConcurrencyStamp", "Created", "Deleted", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "Modified", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "f8c64a88-9be3-41d7-9d27-bde856c62074", new DateTime(2021, 4, 9, 12, 25, 33, 641, DateTimeKind.Local).AddTicks(2654), null, "zoran.milosevic@test.test", true, "Zoran", "Milosevic", false, null, null, "zoran.milosevic@test.test", "ZORAN.MILOSEVIC@TEST.TEST", "AQAAAAEAACcQAAAAEMom5eIbKkLA8zWucfbHkeR0TtK8NVYtkxHgSAOtsmIpZJtJnNjf7QtqFb37cgKhrA==", null, false, "e182d1b6-d60f-4c29-95c8-183c1594a1d0", false, "zoran.milosevic@test.test" });
